...
1. <https://chrome.google.com/webstore/devconsole> にストア用の Google アカウントでログイン
2. 開発者登録料 **5 USD**(一回限り)を支払う
3. 開発者情報に**公開される連絡先メールアドレス**を登録し、確認メールで検証を済ませる(未検証だと審査に出せない)
4. どのアカウントで登録したかをこの節に追記する(更新時に同じアカウントが要る)
...
- 公開範囲: 一般公開 / 限定公開(リンクを知っている人)のどちらか → **§8 の判断**
- 地域: すべての地域
- 価格: 無料
...
- [ ] 公開範囲(一般公開 / 限定公開で様子を見る)
- [ ] ストア用の Google アカウント(hmw.gr.jp / gmail のどちらで登録するか)
- [ ] 公開される連絡先メールアドレス
- [ ] `v0.1.0` の git タグと GitHub リリースを打つか
